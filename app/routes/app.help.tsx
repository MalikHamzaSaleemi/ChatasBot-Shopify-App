...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  return Response.json({
    message: "Help page loaded successfully",
    session,
        ...
        <Layout>
            ...
            <Card>
                ...
                <Text variant="headingLg" as="h2">
                    Welcome to the ChatAsBot Help Center
                </Text>
                <Text as="p" variant="bodyMd">
                    Need assistance? Here are some resources to help you use ChatAsBot.
                </Text>
                <List type="bullet">
                    <List.Item>
                    <Link url="https://chatasbot.com/signup" target="_blank">
                      <BlockStack gap="200">
                        <Text as="p" variant="bodyMd" fontWeight="bold">
                          1- Setting up an account
                        </Text>
                        <Text as="p" variant="bodySm" tone="subdued">
                          How to Integrate Shopify store with ChatAsBot
                        </Text>
                      </BlockStack>
                    </Link>
                    </List.Item>
                    ...
                    <Link url="https://chatasbot.com/blog/how-to-generate-a-chatasbot-api-key-step-by-step-guide-for-shopify-integration" target="_blank">
                        How to generate ChatAsBot API Key.
                    </Link>
                    </List.Item>
                </List>

                    <Text as="p">
                        If you have any questions, feel free to reach out through whats app.
                    </Text>
                    <Text as="p">
                        <Link url="https://api.whatsapp.com/send/?phone=+447877180793" target="_blank">
